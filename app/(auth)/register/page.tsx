...
import { signUpWithEmail, signInWithGoogle, signInWithFacebook } from '@/lib/firebase/auth'
...
export default function RegisterPage() {
  ...
  async function handleFacebookSignUp() {
    ...
    try {
      ...
      setError('Falha ao criar conta com Facebook.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-zinc-400 text-sm">Crie sua conta grátis</p>
        </div>
